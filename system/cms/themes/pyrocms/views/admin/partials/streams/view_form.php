<div class="view-form">
	...
	<?php echo form_open_multipart(uri_string(), 'class="streams_view_form"'); ?>
		...
		<fieldset class="padding-left padding-right">
			...
			<label>
				<input type="checkbox" class="show-column" <?php echo (isset($_GET['column']) and in_array($slug, $_GET['column'])) ? 'checked="checked"' : null; ?> data-column="<?php echo $stream_field->assign_id; ?>">
		...
		<fieldset class="padding-left padding-right">
			...
			<?php echo form_multiselect('columns[]', $stream_fields_dropdown, array()); ?>
